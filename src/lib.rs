...
//!
//! ```no_run
//! use git_wrapper::Repository; // Assuming your crate is named git_wrapper
//! use git_wrapper::types::{GitUrl, BranchName};
//! use std::path::Path;
//! use std::str::FromStr;
//!
...
//!
//! // Add a remote
//! let upstream_url = GitUrl::from_str("[https://example.com/my-upstream.git](https://www.google.com/search?q=https://example.com/my-upstream.git)")?;
...
use std::str;
use types::{BranchName, GitUrl, Result}; // Use our Result alias
